...
namespace BrasilBurger.Web.Repository.Impl
{
    public class CommandeRepository : ICommandeRepository
    {
        ...
        {
            _context.CommandeBurgers.Add(commandeBurger);
            await _context.SaveChangesAsync();
        ...
        {
            _context.CommandeMenus.Add(commandeMenu);
            await _context.SaveChangesAsync();
            return commandeMenu;
        }
        ...
        {
            return await _context.CommandeBurgers
                .Where(cb => cb.IdCommande == commandeId)
                .ToListAsync();
        }

        public async Task<List<CommandeMenu>> GetMenusCommandeAsync(int commandeId)
        {
            return await _context.CommandeMenus
                .Where(cm => cm.IdCommande == commandeId)
                .ToListAsync();
        }
