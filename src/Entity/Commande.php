...
class Commande
{
    ...
    #[ORM\JoinColumn(name: 'id_client', referencedColumnName: 'id_client', insertable: false, updatable: false)]
    private ?Client $client = null;
    #[ORM\ManyToOne(targetEntity: Zone::class)]
    #[ORM\JoinColumn(name: 'id_zone', referencedColumnName: 'id', insertable: false, updatable: false)]
    private ?Zone $zone = null;
    #[ORM\ManyToOne(targetEntity: Livreur::class)]
    #[ORM\JoinColumn(name: 'id_livreur', referencedColumnName: 'id_livreur', insertable: false, updatable: false)]
    ...
    public function setIdLivreur(?int $idLivreur): static { $this->idLivreur = $idLivreur; return $this; }
